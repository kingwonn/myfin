...
CHECKPOINTS = [
    ("2026-07-16", "TSM Q2 财报", "CoWoS 指引是否上修；NVDA 已锁 60% 产能背景下的扩产表态"),
    ("2026-07-22", "GEV Q2 财报", "系统第一张前向成绩单：预注册判分卡 A/B/C/D + Barclays(西门子能源)见顶论对手盘"),
    ("2026-Q3", "CPO 出货裁决", "光模块窗口期是否关闭的触发器（旭创/新易盛证伪条件）"),
    ("2026-07-28", "Bloom Q2+RPO 复核", "Hunterbrook 二次做空(钪依赖+积压审计差)的裁决点"),
